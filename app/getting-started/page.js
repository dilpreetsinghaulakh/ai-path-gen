...
export default function GettingStarted() {
  return (
    <main className=" max-w-7xl mx-auto px-16 w-screen" id="mainContent">
      <div className="flex flex-col items-center h-full gap-10 justify-center">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 max-w-3xl">
            This page uses OpenAI&apos;s API to generate the learning paths. The API is
            not free and I am currently using the free credits but they are
